...
netflix_df = pd.read_csv("F:/data sciense pycharm project/netflix_data.csv")
...
# filter the data to only keep the action movies
...
for lable ,row in action_movies_1990s.iterrows():
    if row["duration"] < 90 :
